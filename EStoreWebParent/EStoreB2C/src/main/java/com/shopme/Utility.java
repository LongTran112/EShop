...
import com.shopme.setting.CurrencySettingTemplate;
import com.shopme.setting.EmailSettingTemplate;
...
public class Utility {
    ...
    public static JavaMailSenderImpl prepareMailSender(EmailSettingTemplate settings) {
    ...
    public static String formatCurrency(float amount, CurrencySettingTemplate settings) {
