...
public class SettingController {
    ...
    public String saveGeneralSettings(@RequestParam("fileImage") MultipartFile multipartFile,
        ...
        GeneralSettingTemplate settingBag = service.getGeneralSettings();
    ...
    private void saveSiteLogo(MultipartFile multipartFile, GeneralSettingTemplate settingBag) throws IOException {
    ...
    private void saveCurrencySymbol(HttpServletRequest request, GeneralSettingTemplate settingBag) {
